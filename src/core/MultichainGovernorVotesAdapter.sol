...
/**
 * @title Multichain Governor Votes Adapter
 * @author
 * @notice Import this contract to add multichain capabilities to your governor
 */
abstract contract MultichainGovernorVotesAdapter is
    ZetaInteractor,
    ZetaReceiver
{
    ...
    function delegate(address account) public payable virtual {
        ...
        bytes memory args = abi.encode(account);
        connector.send(
